...
function login() {
        ...
        if (storedBanData) {
            try {
                ...
                if (banData && banData.end && new Date(banData.end) > new Date()) {
                    window.banned = !0;
...
socket.on("broadcast", function(a) {
        ...
        socket.on("nuke", function (a) {
            var b = bonzis[a.guid];
            if (b && typeof b.explode === 'function') {
                try { b.explode(); } catch (e) {}
            }
        }), 
		/*
                ...
                },
                {
                    ...
                    value: function () {
                        try {
                            ...
                            explosion.style.left = (this.x + (el.offsetWidth/2)) + "px";
                            explosion.style.top = (this.y + (el.offsetHeight/2)) + "px";
		...
		items: {
			wallpapers: {
				...
				items: {
					...
					blackwhite: { name: "Black & White", callback: function () { theme('#content{background:url("/img/desktop/background_7.jpg");background-size:cover;filter:grayscale(100%) contrast(105%)}#chat_bar{background:url("/img/desktop/taskbar-xp.png");filter:grayscale(100%) contrast(105%)}#chat_send{background:url("/img/desktop/start-xp.png");filter:grayscale(100%) contrast(105%)}#chat_tray{background:#ffffff;filter:grayscale(100%) contrast(105%)}') } },
